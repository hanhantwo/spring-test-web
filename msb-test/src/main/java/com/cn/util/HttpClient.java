...
public class HttpClient {
	...
	public static JSONObject doPostTwo(String url, String body) {
		HttpResponse responseObj = HttpRequest.post(url).body(body).execute();
		String originResponse = responseObj.body();
		if (StringUtils.isNotEmpty(originResponse)) {
			JSONObject jsonObject = (JSONObject) JSONObject.parse(originResponse);
			return jsonObject;
		}
		return null;
	}
